Arduino TinyPICO Play Shield
============================

TinyPICO Arduino Play Shield Features Example

This example sketch covers the implementation and use of the following features:

OLED, IMU, Light sensor, buttons, WiFi and sound.

Requirements
------------
The examples in this folder require the TinyPICO Arduino Helper Library
